...
public class FirstService extends Service {
	...
	public void onCreate() {
		...
		try {
			Notification notification = new Notification(
					android.R.drawable.stat_sys_data_bluetooth, "智慧关怀已开启",
					System.currentTimeMillis());
			PendingIntent p_intent = PendingIntent.getActivity(this, 0,
					new Intent(this, SecondService.class), 0);
			notification.setLatestEventInfo(this, "百事通智慧社区",
					"智慧关怀正在运行中!", p_intent);
			startForeground(0x1982, notification); // notification ID: 0x1982,
													// you

			telephonyManager = (TelephonyManager) FirstService.this
					.getSystemService(Context.TELEPHONY_SERVICE);
			locationManager = (LocationManager) FirstService.this
	...
	class NetworkLocationListener implements LocationListener {
		...
		public void onLocationChanged(Location location) {
			...
			if (deviceimpl.uplocation(uplocationDTO) == true) {
				System.out.println("OK");
				Toast.makeText(FirstService.this, "定位上传成功", Toast.LENGTH_SHORT).show();
			}
		}
