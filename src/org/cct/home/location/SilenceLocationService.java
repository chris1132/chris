...
public class SilenceLocationService extends Service {
	...
	public void onCreate() {
		// TODO Auto-generated method stub
		try {
			telephonyManager = (TelephonyManager) SilenceLocationService.this
					.getSystemService(Context.TELEPHONY_SERVICE);
			locationManager = (LocationManager) SilenceLocationService.this
	...
	class NetworkLocationListener implements LocationListener {
		...
		public void onLocationChanged(Location location) {
			...
			if (deviceimpl.uplocation(uplocationDTO) == true) {
				...
				Toast.makeText(SilenceLocationService.this, "OK1",
						Toast.LENGTH_SHORT).show();

				Intent intent = new Intent();
				intent.setClass(SilenceLocationService.this,
						SilenceLocationService.class);
				stopService(intent);
			}
		}
