...
public class SecondService extends Service {
	...
	public void onCreate() {
		...
		try {
			...
			telephonyManager = (TelephonyManager) SecondService.this
					.getSystemService(Context.TELEPHONY_SERVICE);
			locationManager = (LocationManager) SecondService.this
	...
	class NetworkLocationListener implements LocationListener {
		...
		public void onLocationChanged(Location location) {
			...
			if (deviceimpl.upfallalert(uplocationDTO) == true) {
				System.out.println("OK");
				Toast.makeText(SecondService.this, "跌倒报警启动", Toast.LENGTH_SHORT)
						.show();
				
				Intent intent = new Intent();
				intent.setClass(SecondService.this, SecondService.class);
				stopService(intent);
