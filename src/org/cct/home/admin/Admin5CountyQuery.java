...
public class Admin5CountyQuery extends Activity {
	private long areaid;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ImageButton buttonBack = (ImageButton) findViewById(R.id.imageButton_adminhome3_3_3);
		buttonBack.setOnClickListener(new OnClickListener() {

			public void onClick(View v) {
				Admin5CountyQuery.this.finish();
			}
		});
		...
		admin3manage2btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(Admin5CountyQuery.this, County.class);
	...
	private List<Countyinfo> mySelect(String areaname, List<Countyinfo> list,
		...
		adapter = new ArrayAdapter<String>(Admin5CountyQuery.this,
