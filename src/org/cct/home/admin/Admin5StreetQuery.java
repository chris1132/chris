...
public class Admin5StreetQuery extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ImageButton buttonBack = (ImageButton) findViewById(R.id.imageButton_adminhome_3_3_2);
		buttonBack.setOnClickListener(new OnClickListener() {

			public void onClick(View v) {
				Admin5StreetQuery.this.finish();
			}
		});
		...
		admin3manage1btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(Admin5StreetQuery.this,
						Street.class);
	...
	private List<Countyinfo> mySelect(String areaname, List<Countyinfo> list,
		...
		adapter = new ArrayAdapter<String>(Admin5StreetQuery.this, R.layout.item,
