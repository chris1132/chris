...
public class Admin2UseQuery extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		qbtn.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				dialog = ProgressDialog.show(Admin2UseQuery.this, "提交中",
						"正在提交中,请稍后..");
				Thread workThread = new WorkThread();
				workThread.start();

				// Userimpl userimpl = new Userimpl();
				// User user = userimpl.querybyusername(qeditText.getText()
				// .toString().trim());
				// if (user == null) {
				// Toast.makeText(Admin2UseQuery.this,
	...
	class Admin2UseQueryHandler extends Handler {
		public void handleMessage(Message msg) {
			if (msg.what == 1) {
				...
				Toast.makeText(Admin2UseQuery.this, "对不起，没有相关信息！请核对用户名后再查询。",
