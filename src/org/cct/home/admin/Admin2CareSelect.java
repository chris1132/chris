...
public class Admin2CareSelect extends Activity {
	private long areaid;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		admin1selectbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(Admin2CareSelect.this, CareTo.class);
	...
	private List<Countyinfo> mySelect(String areaname, List<Countyinfo> list,
		...
		adapter = new ArrayAdapter<String>(Admin2CareSelect.this,
