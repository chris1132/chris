...
public class Admin3Service extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		add.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(Admin3Service.this, AddService.class);
				Admin3Service.this.startActivity(intent);
				Admin3Service.this.finish();
			}
		});

		dialog = ProgressDialog.show(Admin3Service.this, "加载中", "正在加载,请稍后..",
				true, false);
		new Admin3ServiceThread(Admin3Service.this).start();
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				new AlertDialog.Builder(Admin3Service.this)
						.setTitle("选择操作")
						.setPositiveButton(
								"编辑",
	...
	private class Admin3ServiceThread extends Thread {

		private Admin3Service activity;

		public Admin3ServiceThread(Admin3Service act) {
			activity = act;
		}
		...
		public void run() {
			...
			if (size == 0) {
				...
				listItemAdapter = new SimpleAdapter(Admin3Service.this,
						listItem,// 数据源
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				Toast.makeText(Admin3Service.this, "未查询到任何记录",
