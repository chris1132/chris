...
public class Admin4StreetQuery extends Activity {
	private long areaid;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		admin3manage1btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(Admin4StreetQuery.this,
						Street.class);
	...
	private List<Countyinfo> mySelect(String areaname, List<Countyinfo> list,
		...
		adapter = new ArrayAdapter<String>(Admin4StreetQuery.this, R.layout.item,
