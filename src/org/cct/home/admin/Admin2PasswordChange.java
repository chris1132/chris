...
public class Admin2PasswordChange extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener()
		{
			...
			{
				Admin2PasswordChange.this.finish();
		...
		alterbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!alterEditText1.getText().toString().trim()
					...
					Toast.makeText(Admin2PasswordChange.this, "输入的旧密码不正确，请重新输入",
					...
					Toast.makeText(Admin2PasswordChange.this, "两次输入的新密码不一致，请重新输入",
							Toast.LENGTH_SHORT).show();
					alterEditText1.setText("");
					alterEditText2.setText("");
					alterEditText3.setText("");
						...
						.equals("")) {
					Toast.makeText(Admin2PasswordChange.this, "输入的新密码不能仅为空格，请重新输入",
							Toast.LENGTH_SHORT).show();
					alterEditText1.setText("");
					alterEditText2.setText("");
					alterEditText3.setText("");
				} else {
					new AlertDialog.Builder(Admin2PasswordChange.this)
							.setTitle("提示")
							.setMessage("确定保存修改？")
