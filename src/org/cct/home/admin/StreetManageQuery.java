...
public class StreetManageQuery extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				StreetManageQuery.this.finish();
			}
		});
		TextView text = (TextView) findViewById(R.id.admin4_text);
		text.setText("街道管理员管理");
		...
		admin3manage2btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(StreetManageQuery.this, StreetManage.class);
	...
	private List<Countyinfo> mySelect(String areaname, List<Countyinfo> list,
		...
		adapter = new ArrayAdapter<String>(StreetManageQuery.this,
