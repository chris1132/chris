...
public class Admin1Service extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		add.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(Admin1Service.this, AddService.class);
				Admin1Service.this.startActivity(intent);
				Admin1Service.this.finish();
			}
		});

		dialog = ProgressDialog.show(Admin1Service.this, "加载中", "正在加载,请稍后..",
				true, false);
		new Admin1ServiceThread(Admin1Service.this).start();
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				new AlertDialog.Builder(Admin1Service.this)
						.setTitle("选择操作")
						.setPositiveButton(
								"编辑",
	...
	private class Admin1ServiceThread extends Thread {

		private Admin1Service activity;

		public Admin1ServiceThread(Admin1Service act) {
			activity = act;
		}
		...
		public void run() {
			...
			if (size == 0) {
				...
				listItemAdapter = new SimpleAdapter(Admin1Service.this,
						listItem,// 数据源
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				Toast.makeText(Admin1Service.this, "未查询到任何记录",
