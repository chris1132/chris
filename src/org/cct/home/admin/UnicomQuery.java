...
public class UnicomQuery extends Activity {
	private long areaid;
	private Button admin2manage2btn;
	private Spinner admin2manage2spinner1;
	private Spinner admin2manage2spinner2;
	private Spinner admin2manage2spinner3;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener()
		{
			...
			{
				UnicomQuery.this.finish();

			}
		});
		TextView text = (TextView)findViewById(R.id.liantext);
		text.setText("联通管理员管理");
		admin2manage2spinner1 = (Spinner) findViewById(R.id.admin2manage1spinner1);
		admin2manage2spinner2 = (Spinner) findViewById(R.id.admin2manage1spinner2);
		admin2manage2spinner3 = (Spinner) findViewById(R.id.admin2manage1spinner3);
		admin2manage2btn = (Button) findViewById(R.id.admin2manage1btn);
		...
		admin2manage2spinner1.setAdapter(adapter);
		admin2manage2spinner1.setPrompt("请选择省份：");
		admin2manage2spinner2.setPrompt("请选择市：");
		admin2manage2spinner3.setPrompt("请选择县/区：");
		admin2manage2spinner1
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					@Override
					public void onItemSelected(AdapterView<?> arg0, View item,
							int arg2, long arg3) {
						// TODO Auto-generated method stub
						String areaname = admin2manage2spinner1
								.getItemAtPosition(arg2).toString();
						final List<Countyinfo> list2 = mySelect(areaname,
								list_area, city_adapter, admin2manage2spinner2);
						admin2manage2spinner2
								.setOnItemSelectedListener(new OnItemSelectedListener() {
									@Override
									public void onItemSelected(
											...
											int arg2, long arg3) {
										// TODO Auto-generated method stub
										String areaname = admin2manage2spinner2
												.getItemAtPosition(arg2)
												.toString();
										final List<Countyinfo> list3 = mySelect(
												areaname, list2,
												county_adapter,
												admin2manage2spinner3);
										admin2manage2spinner3
												.setOnItemSelectedListener(new OnItemSelectedListener() {
													public void onItemSelected(
															AdapterView<?> arg0,
															View arg1,
															int arg2, long arg3) {
														String areaname = admin2manage2spinner3
																.getItemAtPosition(
																		arg2)
																.toString();
		...
		admin2manage2btn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.putExtra("areaId", areaid + "");
				intent.setClass(UnicomQuery.this,
						UnicomManage.class);
	...
	private List<Countyinfo> mySelect(String areaname, List<Countyinfo> list,
		...
		adapter = new ArrayAdapter<String>(UnicomQuery.this, R.layout.item,
