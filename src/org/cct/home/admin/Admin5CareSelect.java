...
public class Admin5CareSelect extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		admin1selectbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(Admin5CareSelect.this, CareTo.class);
	...
	private List<Countyinfo> mySelect(String areaname, List<Countyinfo> list,
		...
		adapter = new ArrayAdapter<String>(Admin5CareSelect.this,
