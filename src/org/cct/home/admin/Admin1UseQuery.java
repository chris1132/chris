...
public class Admin1UseQuery extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		qbtn.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				dialog = ProgressDialog.show(Admin1UseQuery.this, "查询中",
						"正在查询,请稍后..", true, false);
				new Admin1UseQueryThread(Admin1UseQuery.this).start();
			}
		});
	}

	private class Admin1UseQueryThread extends Thread {
		private Admin1UseQuery activity;
		
		public Admin1UseQueryThread(Admin1UseQuery act) {
			activity = act;
		}
		...
		public void run() {
			...
			user = userimpl.querybyusername(qeditText.getText()
					.toString().trim());
			if (user == null) {
				i = 1;
			} else {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				Toast.makeText(Admin1UseQuery.this,
						"对不起，没有相关信息！请核对用户名后再查询。", Toast.LENGTH_SHORT)
						.show();
				qtextView22.setText("");
				qtextView33.setText("");
				qtextView44.setText("");
