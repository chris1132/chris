...
public class Admin4CountyQuery extends Activity {
	private long areaid;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// 按钮按下，将抽屉打开
				Admin4CountyQuery.this.finish();

			}
		});
		text = (TextView) findViewById(R.id.admin4_text);
		text.setText("小区管理");
		...
		admin3manage2btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(Admin4CountyQuery.this, County.class);
	...
	private List<Countyinfo> mySelect(String areaname, List<Countyinfo> list,
		...
		adapter = new ArrayAdapter<String>(Admin4CountyQuery.this,
