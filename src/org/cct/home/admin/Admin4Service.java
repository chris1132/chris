...
public class Admin4Service extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		add.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(Admin4Service.this, AddService.class);
				Admin4Service.this.startActivity(intent);
				Admin4Service.this.finish();
			}
		});

		dialog = ProgressDialog.show(Admin4Service.this, "加载中", "正在加载,请稍后..",
				true, false);
		new Admin4ServiceThread(Admin4Service.this).start();
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				new AlertDialog.Builder(Admin4Service.this)
						.setTitle("选择操作")
						.setPositiveButton(
								"编辑",
	...
	private class Admin4ServiceThread extends Thread {
		private Admin4Service activity;

		public Admin4ServiceThread(Admin4Service act) {
			activity = act;
		}
		...
		public void run() {
			...
			if (size == 0) {
				...
				listItemAdapter = new SimpleAdapter(Admin4Service.this,
						listItem,// 数据源
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				break;
			case 1:
				Toast.makeText(Admin4Service.this, "未查询到任何记录",
