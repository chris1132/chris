...
public class CountyManageQuery extends Activity {
	private long areaid;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ImageButton buttonBack = (ImageButton) findViewById(R.id.imageButton_adminhome_2_1_all);
		buttonBack.setOnClickListener(new OnClickListener() {

			public void onClick(View v) {
				CountyManageQuery.this.finish();

			}
		});
		text = (TextView) findViewById(R.id.text);
		text.setText("小区管理员管理");
		...
		admin1selectbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(CountyManageQuery.this,
						CountyManage.class);
	...
	private List<Countyinfo> mySelect(String areaname, List<Countyinfo> list,
		...
		adapter = new ArrayAdapter<String>(CountyManageQuery.this,
